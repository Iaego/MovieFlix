...
const App = () => {
  ...
  //Debounces the search term to avoid excessive API calls while typing
  ...
  const fetchMovies = async (query = '') => {
    ...
    try {
      ...
      :`${API_BASE_URL}/discover/movie?sort_by=popularity.desc&include_adult=false&include_video=false&page=1`;
